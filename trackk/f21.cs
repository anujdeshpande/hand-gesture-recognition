       ...
       this.Invoke((MethodInvoker)delegate
           {
               ...
               textBox2.Text = a.Location.Y.ToString();
                   ...
                   if (a.Location.Y - _y <= 3 && a.Location.Y - _y >= -3 && a.Location.X<_x)//right to left
                   {
                   ...
                   if (a.Location.Y - _y <= 3 && a.Location.Y - _y >= -3 && a.Location.X>_x)//left to right
                   {
                   ...
                   if (a.Location.X - _x <= 3 && a.Location.X -_x >= -3 && a.Location.Y > _y)//top to bottom
                   {
                   ...
                   if (a.Location.X - _x <= 3 && a.Location.X - _x >= -3 && a.Location.Y < _y)//bottom to top
                   {
